...
/// Constants used within the wagon wheel package
class WagonWheelPackageConstants {
  ...
  /// Default WhatsApp green color (used for circle indicator)
  static const Color defaultWhatsAppColor = Color(0xff16A34A);
}
